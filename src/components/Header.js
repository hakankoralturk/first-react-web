...
class Header extends React.Component {
    ...
    //class oluştuğunda çalışacak ilk işlem.
    constructor(){
        super(); //React.Component i kullanabilmek için.

        this.state = { //this içerisinde bulunduğu sınıf demek. sayfanın başlangıç state ine isNavOpen : false atadık.
            isNavOpen : false
        }
    }
        ...
        return (
            <header>
                <nav className="container navbar navbar-expand-lg navbar-light justify-content-between">
                    <a className="navbar-brand" href="#">Eğitimbudur Project</a>
